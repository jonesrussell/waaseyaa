# Mission spec: Drupal-parity feature set

**Charter:** Drupal-parity capabilities: Form API, content moderation, factory/seeder, webhook handling, flash messaging, upload service, Mercure publisher, engagement entities, messaging infrastructure, OAuth2/OIDC provider, scheduling, multi-channel notifications, Redis/Memcached cache backends.
...
Drupal-parity capabilities: Form API, content moderation, factory/seeder, webhook handling, flash messaging, upload service, Mercure publisher, engagement entities, messaging infrastructure, OAuth2/OIDC provider, scheduling, multi-channel notifications, Redis/Memcached cache backends.
