...
|---|---|---|---|---|
| `bin/waaseyaa list` wall-time (median of 10) | 0.01 s | ≤ 110% of pre-cut | 0.01 s | PASS |
| `bin/waaseyaa list` peak memory | 30336 KB | ≤ pre-cut + 4 MiB | 30336 KB | PASS |
| `bin/waaseyaa health:check --json` wall-time (median of 10) | 0.01 s | ≤ 110% of pre-cut | 0.01 s | PASS |
