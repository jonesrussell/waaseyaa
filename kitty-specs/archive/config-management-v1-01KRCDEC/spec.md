<!-- Canonical doctrine spec: docs/specs/config-management-v1.md -->
<!-- Mission metadata: docs/specs/missions/M-003-config-management-v1/mission.json -->
<!-- Mission ID: M-003 | Spec Kitty mission_id below in meta.json -->
