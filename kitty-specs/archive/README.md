...
- `1257-entity-storage-hardening` — WPs landed (#1366, #1367, #1380, #1381 etc. on `main`); GitHub issue #1257 closed 2026-05-03. Status never auto-closed. Much of the surface this mission hardened was subsequently re-architected by M-001 (entity-storage-v2-01KRCDDC), so any residual scope should be re-validated against the post-M-001 storage stack before reviving.
