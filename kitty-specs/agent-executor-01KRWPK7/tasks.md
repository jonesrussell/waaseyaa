...
**Subtasks:**
- [ ] T017 `AgentDefinition` VO + attribute + registry (WP03)
- [ ] T018 Extend `AgentResult` with token + cost fields (WP03)
- [ ] T019 Rewire `AgentExecutor` for new `ToolRegistry` signature (WP03)
- [ ] T020 HITL state machine (WP03)
- [ ] T021 Per-iteration + per-tool-call cancellation polling (WP03)
- [ ] T022 Provider retry with exponential backoff (WP03)
- [ ] T023 Delete `AgentInterface` (WP03)
