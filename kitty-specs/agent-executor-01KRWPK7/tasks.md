...
**Subtasks:**
- [ ] T024 `RunAgent` Messenger message (WP04)
- [ ] T025 `RunAgentHandler` + worker-concurrency guard (WP04)
- [ ] T026 `AgentRunService::enqueue()` + `runInline()` (WP04)
- [ ] T027 `StalledRunReaper` service (WP04)
- [ ] T028 Messenger transport wiring + `config.ai.providers` / scalar config entities (WP04)
