...
**Subtasks:**
- [ ] T010 `AgentRun` entity + enums (WP02)
- [ ] T011 `AgentAuditLog` entity (WP02)
- [ ] T012 Migration with indexes (WP02)
- [ ] T013 `AgentRunRepository` + `AgentAuditLogRepository` (WP02)
- [ ] T014 `AgentRunAccessPolicy` (WP02)
- [ ] T015 Capability seed updates (WP02)
- [ ] T016 `AiAgentEntityServiceProvider` wiring + composer.json bumps (WP02)
