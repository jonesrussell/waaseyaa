<!-- Canonical doctrine spec: docs/specs/migration-platform-v1.md -->
<!-- Mission metadata: docs/specs/missions/M-002-migration-platform-v1/mission.json -->
<!-- Mission ID: M-002 | Spec Kitty mission_id below in meta.json -->
