<!-- Canonical doctrine spec: docs/specs/waaseyaa-migrate-source-wordpress.md -->
<!-- Mission metadata: docs/specs/missions/M-005-waaseyaa-migrate-source-wordpress/mission.json -->
<!-- Mission ID: M-005 | Spec Kitty mission_id below in meta.json -->
