...
branch_strategy: "Planning/base branch: main\nMerge target: main\nExecution worktree is allocated by finalize-tasks per lanes.json.\nDo NOT create a branch manually — spec-kitty agent action implement WP05 handles it.\nDependencies: WP03 must be approved (RecordingEntityQuery needed).\nWP04 should be approved (baseline should reflect final state).\n"
subtasks:
- T020
- T021
- T022
