...
branch_strategy: Plan and merge against main; execution worktree allocated by lanes.json after finalize-tasks. Depends on WP02 — base from WP02's resolved branch. Parallelizable with WP04.
subtasks:
- T012
- T013
- T014
