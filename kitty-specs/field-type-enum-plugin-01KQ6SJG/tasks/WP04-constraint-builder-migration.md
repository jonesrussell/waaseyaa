...
branch_strategy: Plan and merge against main; execution worktree allocated by lanes.json after finalize-tasks. Depends on WP02 — base from WP02's resolved branch. Parallelizable with WP03.
subtasks:
- T016
- T017
- T018
