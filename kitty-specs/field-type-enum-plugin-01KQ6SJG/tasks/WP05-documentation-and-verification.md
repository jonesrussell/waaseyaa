...
branch_strategy: Plan and merge against main; execution worktree allocated by lanes.json after finalize-tasks. Depends on WP03 and WP04 — base from their merged successor branch.
subtasks:
- T019
- T020
- T021
