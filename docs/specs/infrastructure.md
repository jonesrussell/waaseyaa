...
<!-- Spec reviewed 2026-04-22 - PackageManifest attributeEntityTypes; ProviderRegistry entity_auto_register; ServiceProvider::mergeChildProvider; BuiltinRouteRegistrar: MCP route owned by mcp package only, sortRoutesByPriority after provider routes; MigrationLoader resolves package migration dirs via InstalledVersions; queue/notification/scheduler composer extra.waaseyaa.migrations -->
